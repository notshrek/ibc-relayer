export default function Introduction({
  ...
  return (
    <>
      <h1 className="text-lime-300 text-4xl font-semibold mb-8 text-center">
        Browser-based IBC Relayer
      </h1>
      <p className="max-w-[750px] px-4 text-center mb-12 text-xl">
      ...
      <button
        ...
        className="bg-lime-300 hover:bg-lime-200 py-4 px-8 rounded-lg font-medium text-lime-950"
      >
        START RELAYING
      </button>
    </>
