export default function Introduction() {
  return (
    <>
      <h1 className="text-lime-300 text-4xl font-semibold font-clashDisplay mb-8">
        Browser-based IBC Relayer
      </h1>
      <p className="max-w-[60%] text-center mb-12 text-xl font-clashDisplay">
      ...
      <button className="bg-lime-300 hover:bg-lime-200 py-4 px-8 rounded-lg font-clashDisplay font-medium text-lime-950">
        START RELAYING
      </button>
    </>
  );
